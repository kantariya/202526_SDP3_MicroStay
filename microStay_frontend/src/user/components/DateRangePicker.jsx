...
const DateRangePicker = ({ checkIn, checkOut, setCheckIn, setCheckOut }) => {
    return (
        <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 p-1 rounded-xl focus-within:ring-2 focus-within:ring-blue-100 focus-within:border-blue-400 transition hover:border-blue-300">
            ...
            <div className="flex items-center gap-2 flex-1">
                <div className="relative flex-1">
                    <input
                        ...
                        className="w-full bg-transparent text-sm font-bold text-slate-800 outline-none p-2"
